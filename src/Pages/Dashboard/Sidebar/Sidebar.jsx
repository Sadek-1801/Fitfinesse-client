            ...
            <div className={`z-10 md:fixed flex flex-col overflow-x-hidden bg-gray-800 w-64 space-y-6 px-2 py-4 absolute inset-y-0 left-0 transform text-white ${isOpen && '-translate-x-full '
                ...
                <div className="divide-y">
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        {/* Navigation items */}
                        <li>
                            <Link to={"/dashboard"} rel="noopener noreferrer" className="flex items-center p-2 space-x-3 rounded-md">
                                <FaPeopleGroup />
                                <span>Profile</span>
                            </Link>
                        </li>
                        ...
                        {role === 'member' && <li>
                            <Link to={"myTrainer"} rel="noopener noreferrer" className="flex items-center p-2 space-x-3 rounded-md">
                                <FaPeopleGroup />
