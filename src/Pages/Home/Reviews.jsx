...
import SampleNextArrow from "../../Components/Home/SampleNextArrow";
import SamplePrevArrow from "../../Components/Home/SamplePrevArrow";
const Reviews = () => {
    ...
    return (
        ...
        <div className="container flex flex-col items-center mx-auto mb-12 md:p-10 md:px-12">
            <h1 className="p-4 text-white text-4xl font-semibold leading-none text-center">
        ...
        <div className="slider-container mx-auto px-4">
            <Slider {...settings}>
                {reviews.map((review) => (
                    <div
                        key={review._id}
                        className="flex flex-col justify-between max-w-sm mx-4 my-6 shadow-lg border border-gray-400 rounded-lg"
                    >
