...
const Nav = () => {
    ...
    return (
        <header className="relative">
            <div className="container px-6 py-6 mx-auto sm:flex sm:items-center sm:justify-between">
                <div className="flex items-center justify-between">
                    ...
                    <button className="text-gray-600 sm:hidden" onClick={() => setIsOpen(!isOpen)}>
                ...
                <div className={`absolute sm:static transition-all duration-300 w-auto py-4 sm:py-0 right-0 sm:opacity-100 sm:translate-x-0 sm:bg-transparent sm:w-auto top-20 sm:top-24 bg-black ${isOpen ? 'opacity-100' : 'opacity-0 -translate-x-full'}`}>
                    <nav className="flex flex-col items-center space-y-8 sm:flex-row sm:space-y-0 sm:gap-2">
                        <NavLink to={"/"} className="font-medium text-white lg:text-white lg:hover:text-gray-400 lg:mx-4 cursor-pointer">
                            Home
                        </NavLink>
                        <NavLink to={"/trainers"} className="font-medium text-white lg:text-white lg:hover:text-gray-400 lg:mx-4 cursor-pointer">
                            Trainers
                        </NavLink>
                        <NavLink to={"/"} className="font-medium text-white lg:text-white lg:hover:text-gray-400 lg:mx-4 cursor-pointer">
                            Classes
